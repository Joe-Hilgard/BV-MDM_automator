...
subList = c("WIT001", "WIT002", "WIT003", "WIT004", "WIT005", "WIT006", "WIT007", "WIT008",
            ...
            "WIT117", "WIT118", "WIT119", "WIT120", "WIT121", "WIT122")
...
mdm = matrix(c(vtcList, sdmList), ncol=2, nrow=length(subList)*length(boldList))

# change header NrOfStudies to length(subList)*length(boldList)
length(subList)*length(boldList)
header = "
FileVersion:          3
...
# Write that bitch
cat(header, file="CurrentTrial_240.mdm")
write(t(mdm), file="CurrentTrial_240.mdm", append=T)
